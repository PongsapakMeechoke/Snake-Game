...
// Change valocity value based on key press
...
const initGame = () => {
    ...
    if (snakeX === snakeY && snakeY === foodY) {
        updateFoodPosition();
        snakeBody.push([foodY, foodX]); // Add food to snake body array
        score++;
        highScore = score >= highScore ? score : highScore; // is score > high score => high score = score
    ...
    // Shifthing forward value of element in snake body by one
